...
$version = IniRead($version, "version", "Default") ;versao atualizada
$update_url = IniRead($version, "download", "Default") ;ler a atualização
...
IniWrite($update_dir, "version", $version) ;Atualiza o arquivo update a nova versão
